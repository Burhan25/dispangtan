                        ...
                        @auth
                            @if (auth()->user()->role == 'user' || auth()->user()->role == 'dokter')
                                <div class="user-info d-flex align-items-center">
                                    <i class="fas fa-user-circle fa-2x me-2" style="color: green;"></i>
                                    <p class="mb-0">Selamat datang, {{ auth()->user()->name }}
                                        ({{ auth()->user()->role }})
                                    </p>
                                </div>
                            @endif
    ...
    <div class="dropdown mt-3 " style="justify-content: left; display: flex; ">
        ...
        <ul class="dropdown-menu w-auto" aria-labelledby="dropdownMenuButton">
            ...
            <li><a class="dropdown-item cursor-pointer" onclick="RefreshPage('Kambing')">Layanan Konsultasi Hewan
                    Kambing</a></li>
            {{-- <li><a class="dropdown-item cursor-pointer" onclick="RefreshPage('Anjing')">Layanan Konsultasi Hewan
                    Anjing</a></li>
            <li><a class="dropdown-item cursor-pointer" onclick="RefreshPage('Reptil')">Layanan Konsultasi Hewan
                    Reptil</a></li> --}}
        </ul>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="category" name="category"
                                    ...
                                    {{-- <option value="Anjing">Layanan Konsultasi Hewan Anjing</option>
                                    <option value="Reptil">Layanan Konsultasi Hewan Reptil</option> --}}
                                </select>
                            </div>
                        </div>
