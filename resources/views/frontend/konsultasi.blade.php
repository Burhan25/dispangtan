		...
		<div class="game-card">
			<div class="game-card-content">
			  <div class="game-card-image-container"> 
				<img class="game-card-image" src="{{ asset('frontend/img/img-card-konsultasi/Dokter2.jpg') }}" alt="Gambar Game">
			  ...
			  <div class="description">
				...
				<div class="game-title"><h2>Drh. Toto Sukarno</h2>
					<p>Dokter Hewan</p></div>
				
				<div class="info">
				  <div class="info-item">
					<i
					class="bi bi-bag-plus-fill"
					  style="font-size: 2rem; padding-right: 20px"
					></i>
					<div class="info-text">
				...
				<button class="game-card-button">Konsultasi</button>
			  </div>
			</div>
		  </div>
		<div class="game-card">
