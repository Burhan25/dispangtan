...
<body>
    ...
    <section class="slider">
        <div class="hero-slider">
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image:url('{{ asset('frontend/img/cover2.png') }}')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>Dinas <span>Perternakan dan Perikanan </span> Kabupaten Sragen <span></span></h1>
                                <p>Selamat Datang di Website Konsultasi Resmi Dinas Peternakan dan Perikanan Kabubaten
                                    Sragen. Layanan Konsultasi dan Penanganan Kesehatan Hewan. </p>
                                <div class="button">
            ...
            <div class="single-slider" style="background-image:url('{{ asset('frontend/img/slider2.jpg') }}')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>Dinas <span>Peternakan dan Perikanan</span><span> Kabubaten Sragen </span></h1>
                                <p>Selamat Datang di Website Konsultasi Resmi Dinas Peternakan dan Perikanan Kabubaten
                                    Sragen. Layanan Konsultasi dan Penanganan Kesehatan Hewan. </p>
                                <div class="button">
                                    <a href="#" class="btn">Konsultasi</a>
            ...
            <div class="single-slider" style="background-image:url('{{ asset('frontend/img/slider2.jpg') }}')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>Dinas<span> Peternakan dan Perikanan</span> Kabubaten Sragen <span></span></h1>
                                <p>Selamat Datang di Website Konsultasi Resmi Dinas Peternakan dan Perikanan Kabubaten
                                    Sragen. Layanan Konsultasi dan Penanganan Kesehatan Hewan. </p>
                                <div class="button">
                                    <a href="#" class="btn">Konsultasi</a>
                        ...
                        <div class="single-schedule first">
                            <div class="inner">
                                ...
                                <div class="single-content">
                                    <h4>Lokasi</h4>
                                    <p>Dinas Peternakan dan Perikanan Kabupaten Sragen berlokasi
                                        di Jl. Mayor Suharto No.6 – 7, Kebayan 1, Sragen Kulon, Kec. Sragen, Kab Sragen,
                                        Jawa Tengah.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="inner">
                                ...
                                <div class="single-content">
                                    ...
                                    <ul class="time-sidual">
                                        <li class="day">Dinas Peternakan dan Perikanan Kabupaten Sragen beroperasi
                                            pada pukul :
                                        <li class="day">Senin - Jumat <span>07.30-16.00</span></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Layanan Paramedis Kabupaten Sragen</h2>
                        <img src="{{ asset('frontend/img/section-img.png') }}" alt="#">
                        <p>Paramedis merupakan sesorang profesional medis yang memberikan perawatan medis pada hewan
                            yang menuju ke lokasi.
                            Paramedis Dinas Peternakan dan Perikanan Kabubaten Sragen terdapat di setiap kecamatan pada
                            Kabubaten Sragen.
                            Layanan Paramedis dapat digunakan sebagai fasilitas darurat dalam penanganan hewan.</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="portfolio section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Layanan Konsultasi Online Dokter Hewan</h2>
                        <img src="{{ asset('frontend/img/section-img.png') }}" alt="#">
                        <p>Doktor Hewan merupakan profesional medis yang bertanggung jawab pada kesehatan dan
                            kesejahteraan hewan.
                            Layanan konsultasi online dokter hewan pada Dinas Peternakan dan Perikanan Kabupaten Sragen
                            dapat digunakan sebagai fasilitas penanganan hewan secara online.
                            Fasilitas konsultasi online diharapkan mampu menjangkau pelayanan dan penaganan hewan secara
